...
const ProjectModal = ({ project, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="bg-blue-950 bg-opacity-90 border border-accent rounded-lg w-full max-w-4xl h-full max-h-[90vh] flex flex-col relative overflow-hidden">
        <button onClick={onClose} className="absolute top-4 right-4 text-text-dark hover:text-accent transition-colors z-10">
          <FaTimes size={24} />
        </button>
        <div className="flex-grow overflow-y-auto">
          <div className="p-8">
            <h2 className="text-4xl font-bold font-mono text-text-light mb-4">{title}</h2>
            ...
            {report && (
              <div>
                <h3 className="text-2xl font-bold font-mono text-text-light mb-4">Project Report</h3>
