  ...
  return (
    <section className="relative h-screen flex items-center justify-center text-center">
      ...
      <div className="z-10 p-6">
        <h1 className="text-5xl md:text-7xl font-mono font-bold text-text-light mb-4">Hi, I'm [Your Name]</h1>
        <p className="text-xl md:text-2xl text-text-dark mb-8">Machine Learning Engineer & Data Scientist</p>
